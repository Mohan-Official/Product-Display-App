const productDetails = [
    {
      Reference: "Cup and Saucer",
      Name: 'Teapot',
      NewPrice: '$19.12',
      OldPrice: '$23.90',
      Savings: 'SAVE 20%',
      Brand: 'Shree Krishna Collections',
      Categories: 'Home Accessories',
      Design: 'Regular fit, round neckline, short sleeves. Made of extra long staple pima cotton.',
      About:
